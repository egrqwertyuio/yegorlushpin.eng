      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <motion.button
              ...
              className={`flex items-center gap-2 px-6 py-3 font-mono text-sm uppercase tracking-wider transition-all duration-300 ${
                activeCategory === category.id
                  ...
                  : 'border border-cyber-cyan/30 text-gray-400 hover:border-cyber-cyan hover:text-cyber-cyan'
              }`}
              style={{
          ...
          {activeData.map((skill, index) => (
            ...
            >
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-white font-semibold group-hover:text-cyber-cyan transition-colors">
                  {skill.name}
                </h3>
              ...
              <div className="relative h-2 bg-cyber-bg rounded-sm overflow-hidden">
                <motion.div
                  className="absolute top-0 left-0 h-full bg-gradient-to-r from-cyber-cyan to-cyber-blue"
                  initial={{ width: 0 }}
              ...
              {/* Circuit decoration */}
              <div className="absolute top-2 right-2 w-2 h-2 bg-cyber-cyan/30 rounded-full opacity-0 group-hover:opacity-100 transition-opacity" />
            </motion.div>
          ))}
        </motion.div>
        ...
        >
          <p className="text-gray-500 text-sm font-mono">
            <span className="text-cyber-cyan">&gt;</span> Always learning new technologies and improving existing skills
          </p>
        </motion.div>
      </div>
    </section>
