...
export const projectsData = [
  ...
  },
  {
    id: 6,
    title: "Cyber Glass",
    description: "Personal project currently in progress. Smart glasses concept with integrated display technology.",
    ...
    technologies: ["Electronics", "Wearables", "Prototyping"],
    category: "Personal",
    github: "",
    demo: "",
    featured: false,
  ...
  {
    id: 7,
    title: "6DoF Automated Robot",
    description: "Personal project currently in progress. A 6 degrees of freedom robotic arm with automated control system.",
    ...
    technologies: ["Robotics", "Automation", "Embedded Systems", "3D Printing"],
    category: "Personal",
    github: "",
    demo: "",
    featured: false,
  ...
  },
  {
    ...
    description: "Personal AI assistant project inspired by Iron Man's JARVIS. Voice-controlled interface with natural language processing capabilities.",
    ...
    technologies: ["AI", "Python", "Voice Recognition", "NLP"],
    category: "Personal",
    github: "",
    demo: "",
    featured: false,
